...
export default function SMSlogUpdateForm(props) {
  const {
    id: idProp,
    sMSlog: sMSlogModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = sMSlogRecord
      ? { ...initialValues, ...sMSlogRecord }
      : initialValues;
  ...
  const [sMSlogRecord, setSMSlogRecord] = React.useState(sMSlogModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(SMSlog, idProp)
        : sMSlogModelProp;
      setSMSlogRecord(record);
    };
    queryData();
  }, [idProp, sMSlogModelProp]);
  React.useEffect(resetStateValues, [sMSlogRecord]);
  const validations = {
    From: [{ type: "Phone" }],
    To: [{ type: "Phone" }],
    UserName: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            SMSlog.copyOf(sMSlogRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "SMSlogUpdateForm")}
      {...rest}
    >
      <TextField
        label="From"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || sMSlogModelProp)}

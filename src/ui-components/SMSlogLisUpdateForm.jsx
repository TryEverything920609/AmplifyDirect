...
export default function SMSlogLisUpdateForm(props) {
  const {
    id: idProp,
    sMSlogLis: sMSlogLisModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = sMSlogLisRecord
      ? { ...initialValues, ...sMSlogLisRecord }
      : initialValues;
  ...
  const [sMSlogLisRecord, setSMSlogLisRecord] =
    React.useState(sMSlogLisModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(SMSlogLis, idProp)
        : sMSlogLisModelProp;
      setSMSlogLisRecord(record);
    };
    queryData();
  }, [idProp, sMSlogLisModelProp]);
  React.useEffect(resetStateValues, [sMSlogLisRecord]);
  const validations = {
    From: [{ type: "Phone" }],
    To: [{ type: "Phone" }],
    UserName: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            SMSlogLis.copyOf(sMSlogLisRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "SMSlogLisUpdateForm")}
      {...rest}
    >
      <TextField
        label="From"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || sMSlogLisModelProp)}

...
export default function UserProfileListUpdateForm(props) {
  const {
    id: idProp,
    userProfileList: userProfileListModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = userProfileListRecord
      ? { ...initialValues, ...userProfileListRecord }
      : initialValues;
  ...
  const [userProfileListRecord, setUserProfileListRecord] = React.useState(
    userProfileListModelProp
  );
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(UserProfileList, idProp)
        : userProfileListModelProp;
      setUserProfileListRecord(record);
    };
    queryData();
  }, [idProp, userProfileListModelProp]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            UserProfileList.copyOf(userProfileListRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "UserProfileListUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || userProfileListModelProp)}
